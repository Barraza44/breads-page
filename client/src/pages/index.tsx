...
const Index: React.FC = () => {
  return (
    <div className="bg-gradient-to-br from-beige-light to-beige-dark h-screen lg:h-screen">
      <Header/>
      <main className="p-4 md:p-8 lg:mt-16 flex flex-col justify-center items-center lg:h-4/6">
        <div className="flex flex-col justify-center h-full mb-20 items-center lg:grid lg:grid-cols-2 lg:grid-rows-3 lg:mt-44">
